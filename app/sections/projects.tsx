      ...
      <div className="flex flex-col items-center w-full gap-20">
        ...
        <div className="w-[60%] grid grid-cols-2 justify-items-center gap-12">
          ...
          <ProjectCard
            ...
            description="A calorie tracking app that logs user's food intake, utilizng nutritional data from Edamam API. It provides users with insights on their daily nutrients through easy-to-understand charsts and graphs."
            techStack={[
              "TypeScript",
              "React Native",
              "Expo",
